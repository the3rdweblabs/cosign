---
title: Extension: http-message-signatures
description: Vendored x402 http-message-signatures extension - RFC 9421 HTTP Message Signatures for client identity and credit-backed batch settlement.
---
