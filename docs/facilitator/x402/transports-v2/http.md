...
description: Vendored x402 HTTP transport - 402, PAYMENT-REQUIRED, PAYMENT-SIGNATURE, PAYMENT-RESPONSE headers.
---
...
- [BOT Chain scheme](../schemes/exact/scheme_exact_botchain.md)
