...
/** Default price (wei) for one HuBot task per network: 1 tBOT on testnet, 0.001 BOT on mainnet. */
export const DEFAULT_HUBOT_TASK_PRICE: Record<BotNetwork, string> = {
  testnet: "1000000000000000000", // 1 tBOT
  mainnet: "1000000000000000",    // 0.001 BOT
};
 ...
 * per-network default (1 tBOT testnet / 0.001 BOT mainnet).
 */
...
/** Default price (wei) for one market report per network: 0.5 tBOT testnet, 0.015 BOT mainnet. */
export const DEFAULT_MARKET_REPORT_PRICE: Record<BotNetwork, string> = {
  testnet: "500000000000000000",  // 0.5 tBOT
  mainnet: "15000000000000000",   // 0.015 BOT
};
 ...
 * the per-network default (0.5 tBOT testnet / 0.015 BOT mainnet).
 */
